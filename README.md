...
O pipeline final combina tres blocos. Primeiro, texto por palavras com unigrama e bigrama, ou seja, palavras sozinhas e pares de palavras. Segundo, texto por caracteres (opcional), para pegar erros de digitacao e variacoes de escrita. Terceiro, features numericas manuais, como contagem de palavras e pontuacao. Tudo isso e unido por um Pipeline com ColumnTransformer, e usamos LinearSVC como classificador principal, que e um modelo linear forte para texto. A configuracao do SVM foi C=10.0 para um equilibrio entre ajustar bem e nao decorar o treino, dual=False por eficiencia com muitas amostras, class_weight='balanced' para tratar as classes de forma justa e max_iter=3000 para garantir convergencia.
